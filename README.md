...
4. Navigate to the `win_rocm_patch` directory:
```powershell
...
```
- After you've built and installed it, you can test whether it works on your system using this script: [example_hip.py](https://gist.github.com/0xDELUXA/b1086dfde9770cfc4c08d5956740bdd4). It should print `[No Load Needed]`, `[Offloaded]`, etc., and not just error out. [Here](https://gist.github.com/0xDELUXA/13ec313bebcf0536322379b7d40731fb) is my local output. Yes, it isn’t flawless, but at least it does something.
